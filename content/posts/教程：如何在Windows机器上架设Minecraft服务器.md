...
本篇是应群友需求，来介绍一下如何在Windows机器上启动Minecraft服务端供内网用户游玩，以使用服务端上才能运行的插件之类的。关于如何让别人远程连接到你的服务器，可以参见下一篇（等待施工中）。  
...
如果你只是想在家/宿舍/校园网内/~~公司/实验室~~里和小伙伴一起玩的话，那么下一篇的内容就不用再看，照这一节操作就可以了。反之你可以看看（等待施工中）了解如何让别人远程连接到你的服务器。
...
关于这个部分可能需要单独写一篇，因为有很多不同的方法，并且也适用于其他游戏的局域网联机（大概）。请参见下一篇：（等待施工中）
